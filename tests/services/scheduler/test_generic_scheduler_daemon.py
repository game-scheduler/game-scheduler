...
class TestSchedulerDaemonDLQProcessing:
    """Test DLQ message processing functionality."""
    ...
    def test_process_dlq_messages_handles_empty_queue(self, mock_pika, daemon):
    ...
    @patch("services.scheduler.generic_scheduler_daemon.pika")
    def test_process_dlq_messages_republishes_messages(self, mock_pika, daemon):
    ...
    @patch("services.scheduler.generic_scheduler_daemon.pika")
    def test_process_dlq_messages_republishes_without_ttl(self, mock_pika, daemon):
    ...
    @patch("services.scheduler.generic_scheduler_daemon.pika")
    def test_process_dlq_messages_nacks_invalid_messages(self, mock_pika, daemon):
    ...
    @patch("services.scheduler.generic_scheduler_daemon.pika")
    def test_process_dlq_messages_handles_connection_error(self, mock_pika, daemon):
    ...
    def test_run_calls_dlq_processing_on_startup_when_enabled(
    ...
    @patch("services.scheduler.generic_scheduler_daemon.SyncSessionLocal")
    @patch("services.scheduler.generic_scheduler_daemon.time")
    def test_run_calls_dlq_processing_periodically(
        self, mock_time, mock_session, mock_publisher_class, mock_listener_class, mock_event_builder
    ):
    ...
    @patch("services.scheduler.generic_scheduler_daemon.SyncEventPublisher")
    @patch("services.scheduler.generic_scheduler_daemon.SyncSessionLocal")
    def test_run_skips_dlq_processing_when_disabled(
