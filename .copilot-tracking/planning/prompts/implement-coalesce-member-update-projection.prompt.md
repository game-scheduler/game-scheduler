...
# Implementation Prompt: coalesce-member-update-projection

## Implementation Instructions

### Step 1: Create Changes Tracking File

You WILL create `20260426-01-coalesce-member-update-projection-changes.md` in
#file:../changes/ if it does not exist.

### Step 2: Execute Implementation

You WILL follow #file:../../.github/instructions/task-implementation.instructions.md
You WILL systematically implement #file:../plans/20260426-01-coalesce-member-update-projection.plan.md task-by-task
...
1. You WILL provide a markdown style link and a summary of all changes from
   #file:../changes/20260426-01-coalesce-member-update-projection-changes.md to the user:
   - You WILL keep the overall summary brief
   - You WILL add spacing around any lists
   - You MUST wrap any reference to a file in a markdown style link

2. You WILL provide markdown style links to
   .copilot-tracking/planning/plans/20260426-01-coalesce-member-update-projection.plan.md,
   .copilot-tracking/planning/details/20260426-01-coalesce-member-update-projection-details.md,
   and .copilot-tracking/research/20260426-01-coalesce-member-update-projection-research.md
