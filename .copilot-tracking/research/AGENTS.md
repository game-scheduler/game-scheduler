# Research Instructions (Codex)

This file mirrors the Copilot research agent instructions, adapted for Codex directory-scoped guidance.
It applies to files under `.copilot-tracking/research/`.
