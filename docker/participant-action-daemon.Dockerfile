...
# Multi-stage build for Participant Action Daemon Service
...
CMD ["python", "-m", "services.scheduler.participant_action_daemon_wrapper"]
...
COPY services/scheduler/participant_action_daemon_wrapper.py ./services/scheduler/participant_action_daemon_wrapper.py
